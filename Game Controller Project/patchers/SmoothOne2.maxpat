...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation_rect" : [ 144.0, 174.5, 37.0, 20.0 ],
					"style" : "",
					"text" : "* -360"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 144.0, 201.5, 60.0, 20.0 ],
					"style" : "",
					"text" : "offset $1 0"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 144.0, 237.0, 64.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 144.0, 146.5, 18.0, 18.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 439.0, 227.0, 35.0, 15.0 ],
					"style" : "",
					"text" : "Fall"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 386.0, 227.0, 35.0, 15.0 ],
					"style" : "",
					"text" : "Rise"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 303.0, 358.0, 18.0, 18.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 439.0, 358.0, 18.0, 18.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 386.0, 358.0, 18.0, 18.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 439.0, 246.0, 38.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 439.0, 312.0, 112.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 386.0, 246.0, 38.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 386.0, 285.0, 112.0, 20.0 ],
					"style" : "",
					"text" : "translate ms samples"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 303.0, 216.0, 37.0, 15.0 ],
					"style" : "",
					"text" : "Shape"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-177" : [ "Rise2", "Rise 2", 0 ],
			"obj-180" : [ "Fall2", "Fall 2", 0 ],
			"obj-40" : [ "Shape2", "Shape 2", 0 ],
			"parameterbanks" : 			{
